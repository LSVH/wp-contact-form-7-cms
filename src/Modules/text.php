...
add_action( 'wpcf7_init', 'wpcf7cms_add_form_tag_text', 10, 0 );

function wpcf7cms_add_form_tag_text() {
	wpcf7_add_form_tag(
		array( 'text', 'text*', 'email', 'email*', 'url', 'url*', 'tel', 'tel*' ),
		'wpcf7cms_text_form_tag_handler',
		array(
			'name-attr' => true,
		)
	);
...
function wpcf7cms_text_form_tag_handler( $tag ) {
	if ( empty( $tag->name ) ) {
		return '';
	}
...
add_filter( 'wpcf7_validate_text', 'wpcf7cms_text_validation_filter', 10, 2 );
add_filter( 'wpcf7_validate_text*', 'wpcf7cms_text_validation_filter', 10, 2 );
add_filter( 'wpcf7_validate_email', 'wpcf7cms_text_validation_filter', 10, 2 );
add_filter( 'wpcf7_validate_email*', 'wpcf7cms_text_validation_filter', 10, 2 );
add_filter( 'wpcf7_validate_url', 'wpcf7cms_text_validation_filter', 10, 2 );
add_filter( 'wpcf7_validate_url*', 'wpcf7cms_text_validation_filter', 10, 2 );
add_filter( 'wpcf7_validate_tel', 'wpcf7cms_text_validation_filter', 10, 2 );
add_filter( 'wpcf7_validate_tel*', 'wpcf7cms_text_validation_filter', 10, 2 );

function wpcf7cms_text_validation_filter( $result, $tag ) {
	$name = $tag->name;
...
add_filter( 'wpcf7_messages', 'wpcf7cms_text_messages', 10, 1 );

function wpcf7cms_text_messages( $messages ) {
...
add_action( 'wpcf7_admin_init', 'wpcf7cms_add_tag_generator_text', 15, 0 );

function wpcf7cms_add_tag_generator_text() {
	$tag_generator = WPCF7_TagGenerator::get_instance();
	$tag_generator->add( 'text', __( 'text', 'contact-form-7' ),
		'wpcf7cms_tag_generator_text' );
...
function wpcf7cms_tag_generator_text( $contact_form, $args = '' ) {
