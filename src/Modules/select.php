...
add_filter( 'wpcf7_validate_select', 'wpcf7cms_select_validation_filter', 10, 2 );
add_filter( 'wpcf7_validate_select*', 'wpcf7cms_select_validation_filter', 10, 2 );

function wpcf7cms_select_validation_filter( $result, $tag ) {
	$name = $tag->name;
...
add_action( 'wpcf7_admin_init', 'wpcf7cms_add_tag_generator_menu', 25, 0 );

function wpcf7cms_add_tag_generator_menu() {
	$tag_generator = WPCF7_TagGenerator::get_instance();
	$tag_generator->add( 'menu', __( 'drop-down menu', 'contact-form-7' ),
		'wpcf7cms_tag_generator_menu' );
}

function wpcf7cms_tag_generator_menu( $contact_form, $args = '' ) {
