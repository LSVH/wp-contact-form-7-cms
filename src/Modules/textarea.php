...
add_filter( 'wpcf7_validate_textarea',
	'wpcf7cms_textarea_validation_filter', 10, 2 );
add_filter( 'wpcf7_validate_textarea*',
	'wpcf7cms_textarea_validation_filter', 10, 2 );

function wpcf7cms_textarea_validation_filter( $result, $tag ) {
	$type = $tag->type;
	$name = $tag->name;
...
add_action( 'wpcf7_admin_init', 'wpcf7cms_add_tag_generator_textarea', 20, 0 );

function wpcf7cms_add_tag_generator_textarea() {
	$tag_generator = WPCF7_TagGenerator::get_instance();
	$tag_generator->add( 'textarea', __( 'text area', 'contact-form-7' ),
		'wpcf7cms_tag_generator_textarea' );
}

function wpcf7cms_tag_generator_textarea( $contact_form, $args = '' ) {
