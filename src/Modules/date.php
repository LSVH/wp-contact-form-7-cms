...
add_filter( 'wpcf7_validate_date', 'wpcf7cms_date_validation_filter', 10, 2 );
add_filter( 'wpcf7_validate_date*', 'wpcf7cms_date_validation_filter', 10, 2 );

function wpcf7cms_date_validation_filter( $result, $tag ) {
	$name = $tag->name;
...
add_filter( 'wpcf7_messages', 'wpcf7cms_date_messages', 10, 1 );

function wpcf7cms_date_messages( $messages ) {
...
add_action( 'wpcf7_admin_init', 'wpcf7cms_add_tag_generator_date', 19, 0 );

function wpcf7cms_add_tag_generator_date() {
	$tag_generator = WPCF7_TagGenerator::get_instance();
	$tag_generator->add( 'date', __( 'date', 'contact-form-7' ),
		'wpcf7cms_tag_generator_date' );
}

function wpcf7cms_tag_generator_date( $contact_form, $args = '' ) {
